...
def fine_tune(train_files, test_files, use_model="gpt2", downsample=1, nepochs=3):
    global tokenizer
    ...
    train_dataset = list(tokenized_datasets['train']['input_ids'])
#     print('{:8d} jokes encoded in the training set'.format(train_dataset.joke_count))
    ...
    filename = 'models/JokeGen_{}_{:4.2f}subset_{}epochs.pt'.format(use_model,1./downsample,nepochs)
...
if __name__ == "__main__":
    ...
    fine_tune(train_files=train_files, test_files=test_files,
